...
//==============================================================================
MainComponent::MainComponent(GUILectureAudioProcessor& p) : audioProcessor(p), m_pSharedImages(p.getSharedImages()), bigKnob(m_pSharedImages), vertSlider(m_pSharedImages), hitPads(m_pSharedImages)
{
